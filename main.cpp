...
int main(int argc, char *argv[])
{
    ...
    if(parametro1 == "-d")
    {
        if(parametro2 == "-l")
        {
            ...
            gl->exportDesc();
            // gl->exportInfo(); // não precisa dessa função
        }
        if(parametro2 == "-m")
        {
            gm = new grafo_matriz; 
            ...
            gm->exportDesc();
            // gm->exportInfo();  // não precisa dessa função
        }
    }
    if(parametro2 == "-c") 
    {
        ...
        {
            gl = new grafo_lista;
            // gl->carrega_grafo(argv[1], filename); // aqui é novo_grafo
            gl->exportInfo();
        }
        if(parametro1 == "-m")
        {
            gm = new grafo_matriz; 
            // gm->carrega_grafo(argv[1], filename); // aqui é novo_grafo
            gm->exportInfo();
        }
    }
